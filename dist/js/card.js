Vue.component('card-mobile', {
    ...
    template: `
    <figure class="bg-white dark:bg-gray-900 shadow rounded-xl md:rounded-md p-0 overflow-hidden flex flex-row justify-center items-center m-2">
        ...
        <figcaption class="p-4">
            ...
            <span class="rounded-full bg-blue-500 text-sm py-1 px-2 font-semibold text-gray-200">{{ role }}</span>
        </figcaption>
    </figure>
    `
});
...
Vue.component('card-member', {
    props: ['link', 'name', 'role'],
    template: `
    <div class="bg-white dark:bg-gray-900 shadow rounded-md p-5 flex flex-col justify-evenly items-center m-2">
...
Vue.component('card-sponsor', {
    ...
    template: `
    <figure class="bg-white dark:bg-gray-900 shadow-lg rounded-xl md:rounded-md p-0  my-4 mx-2 overflow-hidden flex flex-row justify-center items-center max-w-2xl">
